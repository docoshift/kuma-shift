        ...
        <div>
          ...
          {adminTab==="shift" && (
            <div style={{ padding:"6px 0 4px" }}>
              ...
              <div style={{ overflowX: zoomOut?"hidden":"auto", overflowY: zoomOut?"hidden":"auto", maxHeight:"calc(100vh - 120px)", width:"100%" }}>
                <table style={{ borderCollapse:"collapse", tableLayout:"fixed", width: NAME_W + COL_W * adminDays, ...(zoomOut?{transform:`scale(${Math.min(window.innerWidth/(NAME_W+COL_W*adminDays), (window.innerHeight-200)/(45*16+50))})`,transformOrigin:"top left"}:{}) }}>
